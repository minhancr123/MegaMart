...
export default function CartPage() {
  ...
  if (!mounted || (!user && !error)) {
    return (
      <div className="min-h-screen flex items-center justify-center dark:bg-gray-950 pt-[100px] md:pt-[120px]">
  ...
  if (!cart) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pt-[100px] md:pt-[120px]">
        <div className="container mx-auto py-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">Giỏ hàng của tôi</h1>
