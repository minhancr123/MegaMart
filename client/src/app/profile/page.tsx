...
import { Camera, Package, MapPin, Gift, ChevronRight } from 'lucide-react';
...
export default function ProfilePage() {
    ...
    return (
        <div className="max-w-3xl mx-auto p-4 pt-[100px] md:pt-[120px] dark:bg-gray-950 min-h-screen">
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
              <Link href="/profile/orders" className="flex items-center justify-between p-4 bg-white dark:bg-gray-900 rounded-lg shadow-sm border dark:border-gray-800 hover:shadow-md transition-all group">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center">
                    <Package className="w-5 h-5 text-blue-600 dark:text-blue-400" />
                  </div>
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-white text-sm">Đơn hàng</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400">Quản lý đơn hàng</p>
                  </div>
                </div>
                <ChevronRight className="w-4 h-4 text-gray-400 group-hover:text-blue-600 transition-colors" />
              </Link>

              <Link href="/profile/addresses" className="flex items-center justify-between p-4 bg-white dark:bg-gray-900 rounded-lg shadow-sm border dark:border-gray-800 hover:shadow-md transition-all group">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center">
                    <MapPin className="w-5 h-5 text-green-600 dark:text-green-400" />
                  </div>
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-white text-sm">Địa chỉ</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400">Sổ địa chỉ giao hàng</p>
                  </div>
                </div>
                <ChevronRight className="w-4 h-4 text-gray-400 group-hover:text-green-600 transition-colors" />
              </Link>

              <Link href="/profile/loyalty" className="flex items-center justify-between p-4 bg-white dark:bg-gray-900 rounded-lg shadow-sm border dark:border-gray-800 hover:shadow-md transition-all group">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-amber-100 dark:bg-amber-900/30 flex items-center justify-center">
                    <Gift className="w-5 h-5 text-amber-600 dark:text-amber-400" />
                  </div>
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-white text-sm">Điểm thưởng</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400">Tích điểm & đổi quà</p>
                  </div>
                </div>
