    ...
    <div className="w-full max-w-full overflow-x-hidden dark:bg-gray-950">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
        {[
          ...
          <div
            key={idx}
            className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200"
          >
      ...
      {/* Categories Section */}
      <section>
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 uppercase">Danh mục nổi bật</h2>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {fetchCategories.map((category: any, index: number) => (
            <Link
              key={category.id}
              href={`/category/${category.slug || category.id}`}
              className="group flex flex-col items-center p-4 bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 hover:border-blue-500 dark:hover:border-blue-500 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200"
            >
              <div className="w-14 h-14 rounded-full bg-gray-50 dark:bg-gray-800 flex items-center justify-center mb-3 group-hover:bg-blue-50 dark:group-hover:bg-blue-950 group-hover:scale-105 transition-all duration-200">
                <span className="text-xl font-bold text-gray-600 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-400">{category.name.charAt(0)}</span>
              </div>
              <h3 className="font-medium text-gray-900 dark:text-white text-center text-sm group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200">
                {category.name}
              </h3>
            </Link>
          ))}
      ...
      <section>
        <div className="flex justify-between items-end mb-6">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white uppercase">Gợi ý cho bạn</h2>
        ...
        <div className="mt-8 text-center">
          <Link href="/products">
            <Button size="lg" variant="outline" className="px-12 py-6 text-base border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-blue-600 hover:border-blue-600 transition-all duration-200 rounded-lg hover:scale-[1.02]">
              Xem thêm sản phẩm
            </Button>
          </Link>
        </div>
      ...
      <section className="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-100 dark:border-gray-800 shadow-sm">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white uppercase flex items-center gap-2">
            <Newspaper className="w-6 h-6 text-blue-600 dark:text-blue-400" />
            Tin công nghệ
          </h2>
          <Link href="/news" className="text-blue-600 dark:text-blue-400 hover:underline text-sm font-medium transition-colors duration-200">Xem tất cả</Link>
        </div>
