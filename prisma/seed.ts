import { PrismaClient, UserRole, OrderStatus, PaymentProvider, PaymentStatus } from '../generated/prisma';
...
async function main() {
    ...
    data: {
      ...
      variants: {
        create: [
          {
            sku: 'IP15P-128-NT',
            price: BigInt(2999000000), // 29,990,000 VND
            stock: 50,
            attributes: {
              storage: '128GB',
          ...
          {
            sku: 'IP15P-256-NT',
            price: BigInt(3499000000), // 34,990,000 VND
            stock: 30,
            attributes: {
              storage: '256GB',
              color: 'Natural Titanium',
    ...
    data: {
      ...
      variants: {
        create: [
          {
            sku: 'MBA-M3-8-256-SG',
            price: BigInt(2799000000), // 27,990,000 VND
            stock: 25,
            attributes: {
              ram: '8GB',
              storage: '256GB SSD',
    ...
    data: {
      ...
      variants: {
        create: [
          {
            sku: 'APP-2ND-WHITE',
            price: BigInt(699000000), // 6,990,000 VND
            stock: 100,
            attributes: {
              color: 'White',
    ...
    data: {
      ...
      variants: {
        create: [
          {
            sku: 'GS24-128-BLACK',
            price: BigInt(2199000000), // 21,990,000 VND
            stock: 60,
            attributes: {
              storage: '128GB',
              color: 'Phantom Black',
          ...
          {
            sku: 'GS24-256-BLACK',
            price: BigInt(2599000000), // 25,990,000 VND
            stock: 40,
            attributes: {
              storage: '256GB',
              color: 'Phantom Black',
    ...
    data: {
      ...
      variants: {
        create: [
          {
            sku: 'XPS13-I7-16-512',
            price: BigInt(3299000000), // 32,990,000 VND
            stock: 20,
            attributes: {
  ...
  const order1 = await prisma.order.create({
    data: {
      ...
      total: BigInt(3699000000), // 36,990,000 VND
      vatAmount: BigInt(369900000), // 10% VAT
      ...
      items: {
        create: [
          {
            variantId: (await prisma.variant.findFirst({ where: { sku: 'IP15P-128-NT' } }))!.id,
            price: BigInt(2999000000),
            quantity: 1,
          },
          {
            variantId: (await prisma.variant.findFirst({ where: { sku: 'APP-2ND-WHITE' } }))!.id,
            price: BigInt(699000000),
            quantity: 1,
          },
        ],
      },
  ...
  const order2 = await prisma.order.create({
    data: {
      ...
      total: BigInt(2799000000), // 27,990,000 VND
      vatAmount: BigInt(279900000), // 10% VAT
      shippingFee: BigInt(50000000), // 500,000 VND shipping
      shippingAddress: {
        name: 'Trần Thị B',
        phone: '0987654321',
