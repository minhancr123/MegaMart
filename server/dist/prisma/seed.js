...
async function main() {
    ...
    const userPassword = await (0, bcryptjs_1.hash)('user123', 12);
    ...
    const order1 = await prisma.order.create({
        data: {
            code: 'ORD-2025-001',
            userId: user1.id,
            status: client_2.OrderStatus.PAID,
            total: BigInt(36990000),
            vatAmount: BigInt(3699000),
            ...
            payments: {
                create: {
                    provider: client_2.PaymentProvider.VNPAY,
    ...
    const order2 = await prisma.order.create({
        data: {
            ...
            total: BigInt(28490000),
            vatAmount: BigInt(2799000),
            shippingFee: BigInt(500000),
            shippingAddress: {
                name: 'Trần Thị B',
                phone: '0987654321',
            ...
            payments: {
                create: {
                    provider: client_2.PaymentProvider.MOMO,
                    amount: BigInt(28490000),
                    status: client_2.PaymentStatus.PENDING,
                    currency: 'VND',
                },
            },
        },
